...
.requireItem("input1", <minecraft:clay_ball>)
.requireItem("input2", <minecraft:clay_ball>)
.requireItem("input3", <minecraft:clay_ball>)
.requireItem("input4", <minecraft:clay_ball>)
.requireItem("input5", <minecraft:clay_ball>)
.requireItem("input6", <minecraft:clay_ball>)
.requireItem("input7", <minecraft:clay_ball>)
.requireItem("input8", <minecraft:clay_ball>)
.requireItem("input9", <minecraft:clay_ball>)
...
var recipe2 =AssemblyRecipe.create(function(container){
 container.addItemOutput("output",<contenttweaker:black_brick>);})
.requireItem("input1", <minecraft:brick>)
.requireItem("input2", <contenttweaker:graphite>)
.requireItem("input3", <contenttweaker:graphite>)
.requireItem("input4", <contenttweaker:graphite>)
.requireItem("input5", <contenttweaker:graphite>)
.requireItem("input6", <contenttweaker:graphite>)
.requireItem("input7", <contenttweaker:graphite>)
.requireItem("input8", <contenttweaker:graphite>)
.requireItem("input9", <contenttweaker:graphite>)
